 ...
 */
        public enum x86_report_codes : uint
        {
    ...
    * 'data' is provided by libdisasm and is context-specific, per the enums */
    ...
    public struct x86_ea_t
    {
        ...
        public byte disp_sign;     /* is negative? 1/0 */
        public byte disp_size;     /* 0, 1, 2, 4 */
    }
    ...
    public enum x86_op_datatype : uint
    ...
    public enum x86_op_access : uint
    {    /* ORed together */
        op_read = 1,
        op_write = 2,
        op_execute = 4
    ...
    * implicit operands, should use x86_operand_new in x86_operand_list.h */
    ...
    public enum x86_insn_group : uint
    {
    ...
    public enum x86_insn_type : uint
    {
    ...
    * opcode tables have not been completed. */
    public enum x86_insn_note : uint
    {
    ...
    public enum x86_flag_status : uint
    {
    ...
    * opcode tables have not been completed. */
    ...
    public enum x86_insn_prefix : uint
    {
        insn_no_prefix = 0,
    ...
    public enum x86_asm_format : uint
    {
    ...
    public class asmDataHandler
    {
        ...
        private object RawDeserialize(Type anyType)
        {
            ...
            if (rawsize > m_RawData.Length)
                return null;
            IntPtr buffer = Marshal.AllocCoTaskMem(rawsize);
        ...
        public x86_ea_t expression
        { 
            get 
            {
                return (x86_ea_t)RawDeserialize(typeof(x86_ea_t));
            } 
        }
