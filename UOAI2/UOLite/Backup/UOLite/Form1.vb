    ...
    Public Class UOPacket
        ...
        Public Sub New(ByRef SourceGlob() As Byte, ByVal Size As Integer, ByVal GlobPosition As Integer)
            ...
            Catch ex As Exception
                Throw New ApplicationException("Failed to create UOPacket object: " & ex.Message & vbNewLine & " Position:" & GlobPosition & vbNewLine & " Determined Size:" & Size & vbNewLine & "Glob: " & BitConverter.ToString(SourceGlob))
            End Try
